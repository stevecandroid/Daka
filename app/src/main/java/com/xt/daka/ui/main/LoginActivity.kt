...
import com.xt.daka.util.database.Column
import com.xt.daka.util.database.DataSupport
...
class LoginActivity : BaseActivity(),LoginContract.View {
    ...
    override fun onLoginSuccess() {
        ...
        startActivity(Intent(this@LoginActivity,MainActivity::class.java),bundle)
    }
    ...
    private fun attemptLogin() {
        ...
        val emailStr = account.text.toString()
...
//                    anim.start()
    ...
    data class Test( @Column(true,0) val Key :Int , @Column(pos = 1)val Name : String) : DataSupport(App.app)
